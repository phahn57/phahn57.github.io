...
Training data set is split into 2 parts 70-30. One part for model-building. The other part for model testing.  
...
**Out of sample error** is greater which can be calculated from the second  table below.
